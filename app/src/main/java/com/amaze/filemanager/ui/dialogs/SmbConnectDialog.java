...
public class SmbConnectDialog extends DialogFragment {
  ...
  // Dialog tag.
  public static final String TAG = "jashwant_smbdialog";
  ...
  public SmbConnectionListener getSmbConnectionListener() {
      Log.d(TAG, "getSmbConnectionListener: ");
  ...
  private SmbFile createSMBPath(String[] auth, boolean anonymous, boolean disableIpcSignCheck) {
      for (String var : auth)
      {
          Log.d(TAG, "createSMBPath: auth-"+var);
      }
      Log.d(TAG, "createSMBPath: anonymous-"+anonymous);
      Log.d(TAG, "createSMBPath: disableIpcSignCheck-"+disableIpcSignCheck);
    try {
